...
<body style="background: black;">
  ...
  <br><br>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="usuario" name="usuario" aria-describedby="usuhellp" required>
    ...
    <!--<button type="submit" class="btn btn-primary" href="cadastro.html">Cadastrar ?</button>-->
		...
		if (!empty($erros)) {
			foreach ($erros as $erro) {
				echo ("<script LANGUAGE='JavaScript'>
						window.alert('! Senha Inválido! Tente Novamente...');
